...
import OrderHistory from "@/components/Student/Student-dashboard/OrderHistory";
...
const StudentStory = () => {
  return (
    <>
      <PageHead
        title="My Order History | Student Dashboard – Vidyarishi"
        description="View your course purchase history on Vidyarishi. Track orders, payments, invoices, and enrolled courses."
      />
