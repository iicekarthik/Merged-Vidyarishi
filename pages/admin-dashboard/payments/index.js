...
export default function AdminCoursesPage() {
  return (
    <>
      <PageHead
        title="Payments | Vidyarishi Admin Dashboard"
        description="View and manage student payments, transactions, and course purchases from the Vidyarishi admin dashboard."
      />
